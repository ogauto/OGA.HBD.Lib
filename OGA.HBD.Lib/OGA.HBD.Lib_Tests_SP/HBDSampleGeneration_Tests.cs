...
namespace OGA.HBD.Lib_Tests
{
    /*
        ...
        //  Test_1_5_1  This test walks through the creation of a sample HBD for groundplane01.
        //  Test_1_5_2  This test walks through the creation of a sample HBD for admin01.
        //  Test_1_5_3  This test walks through the creation of a sample HBD for backups01.
*/
    ...
    public class HBDSampleGeneration_Tests : Test_TestBase
    {
        ...
        public async Task Test_1_5_1()
        {
            ...
            // Create an HBD...
            var hbd = this.Generate_HBD_forGroundplane01();
        ...
        public async Task Test_1_5_2()
        {
            ...
            // Create an HBD...
            var hbd = this.Generate_HBD_forAdmin01();
        ...
        public async Task Test_1_5_3()
        {
            ...
            // Create an HBD...
            var hbd = this.Generate_HBD_forBackups01();
        ...
        protected Host_BootstrapDoc Generate_HBD_forGroundplane01()
        {
            var ctime = DateTimeOffset.UtcNow;
            var etime = ctime.AddDays(1);
            ...
            hbd.hostInfo.availZone = "";
            hbd.hostInfo.clusterId = "5FFDEFE6-F85C-4FFF-9477-7AFDDFEE21A3";
            hbd.hostInfo.clusterName = "house-vsphere";
            hbd.hostInfo.creationTime = ctime.ToUnixTimeSeconds();
            hbd.hostInfo.environment = "prod";
            hbd.hostInfo.imageName = "vm-ubuntu24.04";
